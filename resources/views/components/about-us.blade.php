<section class="py-12 2xl:px-20 px-6 xl:mx-auto xl:container">
    <div class="md:flex items-center justify-between">
        <div class="xl:w-5/12 md:w-1/2 xl:pr-16 md:pr-8">
            ...
            <p
                role="contentinfo"
                class="mt-4 text-base leading-6 text-gray-600"
            >
                There are currently 26 letters in the English alphabet, but
                there was once a 27th letter. In fact, it still exists on
                computer keyboards. The 27th letter was "Et" and referred to as
                an "ampersand" or more commonly.
            </p>
            <button
                role="button"
                aria-label="explore more"
                class="sm:w-auto w-full mt-10 text-base font-medium leading-none text-white bg-indigo-700 rounded md:p-4 p-6 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hover:bg-indigo-600 focus:outline-none"
            >
                Explore More
            </button>
        </div>
    ...
    >
        <div>
            <div class="flex items-center">
                <div
                    class="w-10 h-10 bg-indigo-700 rounded-full text-base font-semibold leading-4 text-white flex items-center justify-center"
                >
                    1
                </div>
                <h2
                    class="ml-4 text-base font-semibold leading-4 text-gray-800"
                >
