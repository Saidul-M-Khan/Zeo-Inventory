...
>
    ...
    <form
        id="forgetPassMailForm"
        name="forgetPassMailForm"
        action=""
        class="my-10"
    >
...
<script>
    const forgetPassMailForm = document.getElementById("forgetPassMailForm");

    forgetPassMailForm.addEventListener("submit", async (event) => {
